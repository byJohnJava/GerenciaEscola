...
/**
 * Classe com GUI para cadastrar alunos
 * 
 * @author jaraujo
 * @since 18/02/2020
 * @version 0.1
...
public class AlunoView {
	...
	public void iniciaGui() {
		...
		lblNome.setBounds(10, 5, 100, 100);
		campoNome.setBounds(70, 45, 350, 20);
		...
		botaoSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				aController.consistirDados(campoMatricula.getText(), campoNome.getText(), campoDataNascimento.getText(), campoRg.getText(), campoCpf.getText(), campoTelefone.getText(), jpwSenha.getText(), campoLogradouro.getText(); );
			}
		});
		...
		//Características do Painel Aluno
		painelDoAluno.setBounds(0, 0, 580, 160);
		painelDoAluno.setLayout(null);
		painelDoAluno.setBorder(new TitledBorder("Informações do Aluno"));
		...
		//adicionar componentes do aluno ao painel do Aluno
		painelDoAluno.add(lblMatricula);
		painelDoAluno.add(lblNome);
		painelDoAluno.add(lblDataNascimento);
		painelDoAluno.add(lblSexo);
		painelDoAluno.add(lblTelefone);
		painelDoAluno.add(lblRg);
		painelDoAluno.add(lblCpf);
		painelDoAluno.add(lblSenha);
		painelDoAluno.add(campoMatricula);
		painelDoAluno.add(campoNome);
		painelDoAluno.add(campoDataNascimento);
		painelDoAluno.add(campoTelefone);
		painelDoAluno.add(campoRg);
		painelDoAluno.add(campoCpf);
		painelDoAluno.add(jpwSenha);
		painelDoAluno.add(rbtMasculino);
		painelDoAluno.add(rbtFeminino);
		...
		//adiciona painel aluno e painel endereço no painelDaJanela
		painelDaJanela.setLayout(null);
		painelDaJanela.add(painelDoAluno);
